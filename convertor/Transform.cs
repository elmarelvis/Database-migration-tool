                ...
                case 0:
                    {
                        ...
                        try
                        {
                            ...
                            command.CommandText = "SELECT COLUMN_NAME FROM ALL_TAB_COLUMNS WHERE TABLE_NAME='" + $"{Config.choosenDbTableOfDataView1}'";
                            ...
                            command.CommandText = "SELECT DATA_TYPE FROM ALL_TAB_COLUMNS WHERE TABLE_NAME='" + $"{Config.choosenDbTableOfDataView1}'";
                            command.Connection = cnn;
